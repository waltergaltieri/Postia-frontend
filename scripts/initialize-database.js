...
try {
  ...
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_workspaces_name ON workspaces(agency_id, name);
  `);
  ...
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_social_accounts_connected ON social_accounts(workspace_id, is_connected);
  `);
  ...
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_resources_type ON resources(workspace_id, type);
    CREATE INDEX IF NOT EXISTS idx_resources_name ON resources(workspace_id, name);
    CREATE INDEX IF NOT EXISTS idx_resources_created_at ON resources(workspace_id, created_at DESC);
  `);
  ...
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_templates_type ON templates(workspace_id, type);
    CREATE INDEX IF NOT EXISTS idx_templates_name ON templates(workspace_id, name);
  `);
  ...
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_campaigns_name ON campaigns(workspace_id, name);
  ...
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_campaign_resources_resource ON campaign_resources(resource_id);
  `);
  ...
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_publications_social_network ON publications(social_network);
    CREATE INDEX IF NOT EXISTS idx_publications_calendar ON publications(scheduled_date, status);
    CREATE INDEX IF NOT EXISTS idx_publications_date_status_campaign ON publications(scheduled_date, status, campaign_id);
    CREATE INDEX IF NOT EXISTS idx_publications_campaign_status ON publications(campaign_id, status);
  `);
