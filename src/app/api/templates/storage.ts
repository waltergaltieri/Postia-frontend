...
export const TemplateStorage = {
    ...
    delete(id: string): boolean {
        console.log('Storage: Attempting to delete template:', id)
        console.log('Storage: Current templates:', Array.from(templatesStorage.keys()))
        ...
        if (deleted) {
            saveTemplates(templatesStorage)
            console.log('Storage: Templates saved after deletion')
        }
        return deleted
    },
